...
# (c) TechyMinati ( Aryan Sinha ) <sinha.aryan03@gmail.com>
 ...
 ​import​ ​sys 
 ​print​ (​"=========================================="​) 
 ​print​ (​"      Welcome to ArrowOS Sync Script    "​) 
 ​print​ (​"=========================================="​) 
 ...
 ​    ​os​.​system​(​f'repo init -u https://github.com/ArrowOS/android_manifest.git -b ​{​branch​}​'​) 
 ​    ​print​ (​"Starting Repo Sync"​) 
 ​    ​os​.​system​(​'repo sync -c --force-sync --optimized-fetch --no-tags --no-clone-bundle --prune -j4'​) 
 ​else​ : 
